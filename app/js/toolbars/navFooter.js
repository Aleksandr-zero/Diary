...
export class NavFooter_CreateNote {
    ...
    */
    ...
    createNotesCounter(numberNotes) {
        ...
        if (this.activeItemBlockApp.querySelector(".app-month__content-item-counter-notes")) {

            this.classAppMonth.changeScoreNumber_NotesCounter(
                this.activeBlockDay = this.activeItemBlockApp,
                this.numberScroe = numberNotes
            );
